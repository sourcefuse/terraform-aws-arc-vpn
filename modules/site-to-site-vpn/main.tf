...
resource "aws_vpn_connection_route" "this" {
  for_each = { for obj in nonsensitive(var.vpn_connection_config.routes) : obj.destination_cidr_block => obj }
...
resource "aws_vpn_gateway_route_propagation" "this" {
  for_each = toset(nonsensitive(var.vpn_gateway_config.route_table_ids))
